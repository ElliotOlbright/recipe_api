...
ActiveRecord::Schema.define(version: 2021_11_11_161154) do
  ...
  create_table "recipe_instructions", force: :cascade do |t|
    ...
    t.index ["instruction_id"], name: "index_recipe_instructions_on_instruction_id"
  ...
  add_foreign_key "recipe_instructions", "instructions"
